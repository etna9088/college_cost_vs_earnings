...
# Load dataset
college <- readr::read_csv("college_scorecard_data.csv") %>%
  type_convert(
...
This histogram shows how college attendance costs are distributed. It helps us understand the typical cost range and whether some colleges are much more expensive than others. Most colleges have an average cost between $10k and $30k, with a noticeable peak around $20k. As costs increase beyond $30k, the number of colleges decreases. Very few institutions have costs above $60k, and there are no extreme outliers.
...
This histogram shows the distrubution of how much college graduates earn 10 years after entry. It helps us see typical earnings, the overall pattern, and if there are any outliers. The histogram above is right-skewed with the most earnings concentrated around $40k. Most of the data is in range of $0 to $100k. There are few colleges showing higher earnings above $100k, and few outliers between $120k and $250k. 
...
This scatterplot shows the covariation between two continuous variables: average cost of attendance and median earning after 10 years of entry. It helps us see if spending more on colleges leads to higher earnings. There is a week upward trend: colleges with higher costs tend to have slightly higher earnings. Most colleges have costs below around $50k and earnings below around $70k. A few colleges have very high costs (over $70k) or very high earnings (over $100k).
...
```
This violin plot shows how median earnings of graduates after 10 years on entry vary by institution type: public, private non-profit (PNP), and private for-profit (PFP). It helps us compare the range and patterns of earnings for each type of institution. 
The violin plot by type:
...
The linear model shows a statistically significant relationship between average cost and median earnings. The slope indicates that for every $1 increase in average cost, median earning increase by around $4.59. However, the R-squared value (34.4%) suggests that average cost alone doesn't fully explain variations in median earnings. The model's significance (very low p-value) confirms that relationship is unlikely due to a random chance.
...
*Linearity:* reasonably satisfied, the points roughly follow along the red diagonal line, with some scatter suggesting the model doesn't fully capture all variability.
*Homoscedasticity:* the residuals are scattered around the horizontal red line at 0, but the spread of residuals increases slightly as predicted values increase, which suggests a mild violation of the homoscedasticity assumption.
*Normality of Residuals:* Most points lie close to the red diagonal line, indicating the residuals are approximately normally distributed. However, the tails deviate significantly from the line, which means presence of outliers. 
